...
/**
 * Команда buy. Купува билет за конкретно място и извежда генерирания код.
 */
public class BuyCommand implements Command {
    /**
     * Преобразува ред, място и дата, проверява дали представлението съществува и купува билет.
